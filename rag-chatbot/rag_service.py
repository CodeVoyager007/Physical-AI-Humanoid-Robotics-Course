...
class RAGService:
    ...
    def generate_answer(self, query: str, context: str = None, software_background: Optional[str] = None, hardware_background: Optional[str] = None) -> str:
...
Factual Summary:"""
        ...
        persona_system_instruction = "You are a friendly and knowledgeable AI assistant specializing in the content of the book \"A Textbook for Teaching Physical AI & Humanoid Robotics\". Your personality is helpful, engaging, and you speak like a human expert."

        if software_background and hardware_background:
            persona_system_instruction += f" You are conversing with a user who has a '{software_background}' software background and a '{hardware_background}' hardware background. Tailor your language, analogies, and depth of explanation to best suit this user's expertise level."
